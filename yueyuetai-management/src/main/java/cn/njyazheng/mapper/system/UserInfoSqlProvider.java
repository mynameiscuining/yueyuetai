...
import cn.njyazheng.domain.system.UserInfoExample.Criteria;
import cn.njyazheng.domain.system.UserInfoExample.Criterion;
...
public class UserInfoSqlProvider {
    ...
    public String updateByPrimaryKeySelective(UserInfo record) {
        ...
        if (record.getLocked() != null) {
            sql.SET("locked = #{locked,jdbcType=INTEGER}");
        }
